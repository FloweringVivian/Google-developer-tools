...
![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-2.png)
...
![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-3.png)



还有一个方法，如果想要找到一个元素绑定的事件，我喜欢用google浏览器的search all files，搜索元素的id或class，从而找到该元素在js中绑定的事件，如下图：

![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-4.png)



（4）在HTML面板中选中一个元素，鼠标右键点击，会看到一个弹窗，里面有若干选项：

![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-5.png)
...
* Break on：为该元素添加dom操作事件监听。包含三个选项（树结构改变、属性改变、节点移除）。这个选项的作用是帮助我们监控和定位操作元素的代码 
  ...
  ![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-6.png)
...
![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-8.png)
...
![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-9.png)
...
![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-10.png)
...
![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-11.png)
...
![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-12.png)
...
![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-13.jpg)
...
![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-14.png)
...
![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-15.png)
...
![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-16.png)
...
![](https://github.com/FloweringVivian/Google-developer-tools/blob/master/images/elements-17.png)
